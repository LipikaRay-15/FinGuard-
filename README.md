...
- **CustomTkinter**: Modern GUI framework (v5.2.2) providing styled, theme-aware widgets with Dark/Light mode support for the desktop interface.
- **Matplotlib**: Data visualisation library (v3.11.0) rendering analytics charts (bar, line, pie) embedded directly in the GUI via FigureCanvasTkAgg.
- **Pillow**: Image processing library (v12.2.0) handling icon loading and image assets for the CustomTkinter interface.
